...
export default function Home() {
  ...
  if (!session) {
    return (
      <main className="bg-blue-100 w-screen h-screen flex flex-col justify-center  items-center gap-10 sm:justify-around ">
        {/* <h1 className="mb-4 text-3xl sm:5xl font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-6xl">
          <span class="text-transparent bg-clip-text bg-gradient-to-r to-blue-700 from-sky-400">
            Vender Admin Panel
          </span>
        </h1> */}
